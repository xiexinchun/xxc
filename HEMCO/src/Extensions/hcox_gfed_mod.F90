...
!==============================================================================
       ...
       SELECT CASE ( Inst%SpcNames(N) )
          CASE ( 'BBOCPI' )     !xxc+change OCPI to BBOCPI 
             SpcArr = SpcArr * Inst%OCPIfrac
          CASE ( 'BBOCPO' )     !xxc+change OCPO to BBOCPO 
...
!
       ...
       CALL HCO_EmisAdd( HcoState, SpcArr3D, Inst%HcoIDs(N), RC,ExtNr=Inst%ExtNr )
!==============================================================================

       ! Add flux to HEMCO emission array
       !CALL HCO_EmisAdd( HcoState, SpcArr, Inst%HcoIDs(N), RC, ExtNr=Inst%ExtNr )!xxc_comment out this
       IF ( RC /= HCO_SUCCESS ) THEN
