...
!
    ...
    !              "ssa.dat","ssc.dat","brc_bf_nonab.dat", &
    !              "brc_bfa_nonab.dat","brc_bb_nonab.dat", &
    !              "brc_bba_nonab.dat","dust.dat"/

    DATA SPECFIL /"so4.dat","soot.dat","org.dat", &
                  "ssa.dat","ssc.dat","brc_bf.dat",&
                  "brc_bfa_mod.dat","brc_bb.dat","brc_bba_mod.dat",&
                  "dust.dat"/
    !xxc-- +brc
    ...
    DO k = 1, NSPAA
       ...
       ! Test if the file exists(inquire)
...
!
    ...
    do K = 1,W_
       ...
       do L = 1,L1_
          ...
          do I=1,12   !!!xxc change 8 to 12 (aerosols from 5 to 9)
...
!
    ...
    IND = (/22,29,36,43,50,36,36,36,36/)  !xxc  wx+36
    ...
    DO I=1,NRHAER
       DO J=1,NRH
          MIEDX(10+((I-1)*NRH)+J)=IND(I)+J-1      !xxcc
       ENDDO
    ENDDO
