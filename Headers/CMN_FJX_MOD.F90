...
!BOC
    ...
    IF ( Input_Opt%LUCX ) THEN
       ...
       ! For RRTMG:
       NSPAA        = 8   ! number of species in LUT !xxc+change 8 to 10 0421: to 8
       NASPECRAD    = 16  ! aerosol species in RT
       NSPECRAD     = 18  ! aerosol+gas species in RT
    ELSE
       AN_          = 55  ! # of separate aerosols per layer  !xxc change 45 to 55
       W_           = 12  ! # of wavelength bins

       ! For RRTMG:
       NSPAA        = 10  ! number of species in LUT !xxc change 6 to 9 TO 10
